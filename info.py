...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002092666907') # support group id ( make sure bot is admin )
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movies_hub490')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/maam_movies_backup') #Support group link ( make sure bot is admin )
